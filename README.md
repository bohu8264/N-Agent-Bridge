...
- [查看 0.12.5 发布说明、安装包与源码包](https://github.com/bohu8264/N-Agent-Bridge/releases/tag/v0.12.5-development)
...
目前 **NuPhy Air75 V3** 已完整硬件验证。**Kick75 IO** 已完成精确识别、板载 F1–F12/旋钮、USB-C 下六颗 Agent 单键状态灯，以及 Mac 灯光区背光/侧灯验证。Air65 V3、Air100 V3、Node75、Node100 已加入官方身份 Profile，可先使用不写固件的安全软件按键模式。
...
灯效按型号开放：Air75 V3 侧灯支持流光、霓虹、常亮、呼吸、律动；Kick75 官方只支持前四种，应用不会向 Kick75 写入不兼容的“律动”模式。旧版曾写入该模式时，可按一次 `Fn + M + ←` 恢复。
