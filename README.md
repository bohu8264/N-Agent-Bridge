...
当前版本：**0.14.1 Development**，适配 NuPhy Air75 V3 官方固件 **1.0.16.6**。

- [下载 0.14.1 DMG](https://github.com/bohu8264/N-Agent-Bridge/releases/download/v0.14.1-development/NAgentBridge-0.14.1-Development.dmg)
- [发布说明与源码](https://github.com/bohu8264/N-Agent-Bridge/releases/tag/v0.14.1-development)
- SHA-256：`83edbae8f6b88c101ab1f976314a0b4c26dc7ccc70f21d5a8aff8f9edb239fa3`
...
官方 NuPhyIO 会先发送 `0xEE SetSecretKey` 建立单字节 XOR 会话。固件 1.0.16.6 的响应保留明文路由头、仅加密 payload；旧固件则会加密路由头和 payload。0.14.1 在每个逻辑事务前重新握手，同时兼容两种返回格式。
